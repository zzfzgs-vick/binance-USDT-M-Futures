<!-- Source: https://developers.binance.com/docs/zh-CN/derivatives/portfolio-margin/trade/New-CM-Order -->
...
## 请求参数[​](/docs/zh-CN/derivatives/portfolio-margin/trade/New-CM-Order#请求参数 "请求参数的直接链接")
...
UM条件单下单(TRADE)](/docs/zh-CN/derivatives/portfolio-margin/trade/New-UM-Conditional-Order)[下一页

CM条件单下单(TRADE)](/docs/zh-CN/derivatives/portfolio-margin/trade/New-CM-Conditional-Order)

* [接口描述](/docs/zh-CN/derivatives/portfolio-margin/trade/New-CM-Order#接口描述)
* [HTTP请求](/docs/zh-CN/derivatives/portfolio-margin/trade/New-CM-Order#http请求)
* [请求权重](/docs/zh-CN/derivatives/portfolio-margin/trade/New-CM-Order#请求权重)
* [请求参数](/docs/zh-CN/derivatives/portfolio-margin/trade/New-CM-Order#请求参数)
* [响应示例](/docs/zh-CN/derivatives/portfolio-margin/trade/New-CM-Order#响应示例)